...
<div class="row">
    ...
    <div class="col-md-3">
        <x-adminlte-info-box title="PASIEN BULAN INI" text="{{$pasienBulanIni}}" icon="fas fa-lg fa-clipboard"
            theme="success" />
    </div>
    <div class="col-md-3">
        <x-adminlte-info-box title="PASIEN POLI BULAN INI" text="{{$pasienPoliBulanIni}}" icon="fas fa-lg fa-hospital"
            theme="danger" />
    </div>
    <div class="col-md-3">
        <x-adminlte-info-box title="PASIEN POLI HARI INI" text="{{$pasienPoliHariIni}}" icon="fas fa-lg fa-stethoscope"
            theme="info" />
    </div>
</div>

<x-adminlte-card
    title="{{ $poliklinik != 'Poliklinik tidak ditemukan' ? ucwords(strtolower($poliklinik)) : 'Poliklinik' }}"
...
<div class="row">
    <div class="col-md-6">
        <x-adminlte-card theme="info"
            title="Pasien {{ $poliklinik != 'Poliklinik tidak ditemukan' ? ucwords(strtolower($poliklinik)) : 'Poliklinik' }} Paling Aktif"
            theme-mode="outline">
    ...
    <div class="col-md-6">
        <x-adminlte-card theme="info"
            title="Antrian 10 Pasien Terakhir {{ $poliklinik != 'Poliklinik tidak ditemukan' ? ucwords(strtolower($poliklinik)) : 'Poliklinik' }}"
            theme-mode="outline">
