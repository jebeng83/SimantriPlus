...
class TestPcareTraitDirect
{
    use PcareTrait;
    
    public function testKunjunganTraitDirect()
    {
        echo "=== TEST PCARE KUNJUNGAN DENGAN TRAIT LANGSUNG ===\n";
        ...
        try {
            ...
            // 5. Siapkan data kunjungan untuk POST (bukan PUT)
            echo "\n3. Menyiapkan data kunjungan untuk POST...\n";
            ...
            // 6. Test POST kunjungan menggunakan PcareTrait
            echo "\n4. Testing POST kunjungan menggunakan PcareTrait...\n";
            try {
            ...
            // 7. Test dengan content-type text/plain seperti Java
            echo "\n5. Testing POST kunjungan dengan content-type text/plain...\n";
            try {
                $postResponse = $this->requestPcare('kunjungan', 'POST', $kunjunganData, 'text/plain');
                echo "✓ POST kunjungan (text/plain) berhasil dikirim\n";
                ...
                echo "❌ POST kunjungan (text/plain) gagal: " . $e->getMessage() . "\n";
            }
...
// Jalankan test
$test = new TestPcareTraitDirect();
$test->testKunjunganTraitDirect();
